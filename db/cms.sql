...
CREATE TABLE `vehiclemaster` (
  ...
  `Name` text NOT NULL,
  `remarkDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
  `CamLocation` varchar(255) NOT NULL,
  `Speed` int(11) NOT NULL,
  `Event` text NOT NULL 
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- --------------------------------------------------------
-- Table structure for table `ownermaster`
--
...
-- Table structure for table `cameramaster`
--

CREATE TABLE `cameramaster` (
  `CamLocation` varchar(255) NOT NULL,
...
CREATE TABLE `tblcomplaints` (
  ...
  `Healthissue` varchar(100) NOT NULL,
  'issuepertainduration' varchar(255) NOT NULL,
  `Healthissuedetails` mediumtext NOT NULL,
  `Diseasefile` varchar(255) DEFAULT NULL,
...
CREATE TABLE `users` (
  `id` int(11) NOT NULL,
  `fullName` varchar(255) DEFAULT NULL,`userEmail` varchar(255) DEFAULT NULL, `password` varchar(255) DEFAULT NULL, `contactNo` bigint(11) DEFAULT NULL, `address` tinytext, `State` varchar(255) DEFAULT NULL, `country` varchar(255) DEFAULT NULL, `pincode` int(6) DEFAULT NULL, `userImage` varchar(255) DEFAULT NULL,
  `regDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
