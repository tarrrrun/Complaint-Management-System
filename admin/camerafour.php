...
function printDiv() {
            var divContents = document.getElementById("camfour").innerHTML;
...
AND `vehiclemaster`.`CamLocation` = `cameramaster`.`CamLocation` AND `cameramaster`.`CamLocation` LIKE 'Camera4';");
