...
function printDiv() {
            var divContents = document.getElementById("camtwo").innerHTML;
...
AND `vehiclemaster`.`CamLocation` = `cameramaster`.`CamLocation` AND `cameramaster`.`CamLocation` LIKE 'Camera2';");
