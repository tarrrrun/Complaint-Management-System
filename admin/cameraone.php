...
function printDiv() {
            var divContents = document.getElementById("camone").innerHTML;
...
AND `vehiclemaster`.`CamLocation` = `cameramaster`.`CamLocation` AND `cameramaster`.`CamLocation` LIKE 'Camera1';");
