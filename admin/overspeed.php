...
function printDiv() {
            var divContents = document.getElementById("ospeed").innerHTML;
...
AND `vehiclemaster`.`CamLocation` = `cameramaster`.`CamLocation` AND `ownermaster`.`Name` = `headmaster`.`Name` AND `vehiclemaster`.`Event`LIKE 'Over Speed';");
